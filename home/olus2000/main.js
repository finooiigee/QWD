...
var $author$project$Main$Node = function (a) {
	return {$: 'Node', a: a};
};
var $author$project$Main$Tree = function (a) {
	return {$: 'Tree', a: a};
};
var $author$project$Main$defaultOperators = _List_fromArray(
	[
		{
		arity: 1,
		body: '[ 1 ] [ 1 ]',
...
var $author$project$Main$buildOpDict = function (operators) {
			...
			function (x) {
				...
				if (_v0.$ === 'Err') {
					...
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							x.name,
							{arity: x.arity, skeleton: skeleton}));
				}
			},
			operators));
};
...
var $author$project$Main$newOperator = function (time) {
	return {
		arity: 0,
		body: '',
...
var $author$project$Main$keywords = $elm$core$Set$fromList(
	_List_fromArray(
		['[', ']', '(', ')', '--']));
...
var $author$project$Main$parseExpressionNode = function (token) {
	return A2($elm$core$Set$member, token, $author$project$Main$keywords) ? $elm$core$Result$Err(
		$author$project$Main$Error(
			_List_fromArray(
				['Word \"' + (token + '\" is a restricted keyword.')]))) : $elm$core$Result$Ok(token);
};
var $author$project$Main$parseExpressionTree = function (tokens) {
	if (!tokens.b) {
		...
		switch (tokens.a) {
			case ']':
				return $elm$core$Result$Ok(
					_Utils_Tuple2(_List_Nil, tokens));
			case '[':
				var tail = tokens.b;
				var _v1 = $author$project$Main$parseExpressionTree(tail);
				if (_v1.$ === 'Err') {
					var e = _v1.a;
					return $elm$core$Result$Err(e);
				} else {
					if (_v1.a.b.b && (_v1.a.b.a === ']')) {
						var _v2 = _v1.a;
						var expression = _v2.a;
						var _v3 = _v2.b;
						var rest = _v3.b;
						var _v4 = $author$project$Main$parseExpressionTree(rest);
						if (_v4.$ === 'Err') {
							var e = _v4.a;
							return $elm$core$Result$Err(e);
						} else {
							...
							return $elm$core$Result$Ok(
								_Utils_Tuple2(
									A2(
										$elm$core$List$cons,
										$author$project$Main$Tree(expression),
										l),
									unparsed));
						}
					} else {
			...
			default:
				var s = tokens.a;
				var tail = tokens.b;
				var _v7 = $author$project$Main$parseExpressionNode(s);
				if (_v7.$ === 'Err') {
					var e = _v7.a;
					return $elm$core$Result$Err(e);
				} else {
					var n = _v7.a;
					var _v8 = $author$project$Main$parseExpressionTree(tail);
					if (_v8.$ === 'Err') {
						var e = _v8.a;
						return $elm$core$Result$Err(e);
					} else {
...
var $author$project$Main$words = function (s) {
	var _v0 = $elm$core$String$trim(s);
	if (_v0 === '') {
		return _List_Nil;
	} else {
		return $elm$core$String$words(s);
	}
};
var $author$project$Main$parseExpression = function (str) {
	var _v0 = $author$project$Main$parseExpressionTree(
		$author$project$Main$words(str));
	if (_v0.$ === 'Err') {
		var e = _v0.a;
		return $elm$core$Result$Err(e);
	} else {
...
var $author$project$Main$whitespace = $elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_chr('\n'),
			_Utils_chr('\t'),
...
var $author$project$Main$checkName = function (name) {
	return (name === '') ? $elm$core$Maybe$Just(
		$author$project$Main$Error(
			_List_fromArray(
				['Operator name is empty.']))) : ((!$elm$core$Set$isEmpty(
		A2(
			$elm$core$Set$intersect,
			$author$project$Main$whitespace,
			$elm$core$Set$fromList(
				$elm$core$String$toList(name))))) ? $elm$core$Maybe$Just(
		$author$project$Main$Error(
			_List_fromArray(
				['Whitespace is not allowed in operator names.']))) : (A2($elm$core$Set$member, name, $author$project$Main$keywords) ? $elm$core$Maybe$Just(
		$author$project$Main$Error(
			_List_fromArray(
				['Name \"' + (name + '\" is a restricted keyword.')]))) : $elm$core$Maybe$Nothing));
};
...
var $author$project$Main$parseSkeletonNode = F2(
	function (arity, token) {
		var _v0 = $elm$core$String$toInt(token);
		if (_v0.$ === 'Just') {
			var n = _v0.a;
			return ((n > 0) && (_Utils_cmp(n, arity) < 1)) ? $elm$core$Result$Ok(n) : $elm$core$Result$Err(
				$author$project$Main$Error(
					_List_fromArray(
						['Only numbers refering to operator arguments can be used in operator body.', '\"' + (token + '\" doesn\"t refer to an operator argument.')])));
		} else {
			return $elm$core$Result$Err(
				$author$project$Main$Error(
					_List_fromArray(
						['Only numbers refering to operator arguments can be used in operator body.', '\"' + (token + '\" is not a number.')])));
		}
	});
var $author$project$Main$parseSkeletonTree = F2(
	function (arity, tokens) {
		if (!tokens.b) {
			return $elm$core$Result$Ok(
				_Utils_Tuple2(_List_Nil, _List_Nil));
		} else {
			switch (tokens.a) {
				...
				case '[':
					var tail = tokens.b;
					var _v1 = A2($author$project$Main$parseSkeletonTree, arity, tail);
					if (_v1.$ === 'Err') {
						var e = _v1.a;
						return $elm$core$Result$Err(e);
					} else {
						if (_v1.a.b.b && (_v1.a.b.a === ']')) {
							...
							var _v3 = _v2.b;
							var rest = _v3.b;
							var _v4 = A2($author$project$Main$parseSkeletonTree, arity, rest);
							if (_v4.$ === 'Err') {
								var e = _v4.a;
								return $elm$core$Result$Err(e);
							} else {
								...
								return $elm$core$Result$Ok(
									_Utils_Tuple2(
										A2(
											$elm$core$List$cons,
											$author$project$Main$Tree(skeleton),
											l),
										unparsed));
							}
						} else {
				...
				default:
					var s = tokens.a;
					var tail = tokens.b;
					var _v7 = A2($author$project$Main$parseSkeletonNode, arity, s);
					if (_v7.$ === 'Err') {
						var e = _v7.a;
						return $elm$core$Result$Err(e);
					} else {
						var n = _v7.a;
						var _v8 = A2($author$project$Main$parseSkeletonTree, arity, tail);
						if (_v8.$ === 'Err') {
							var e = _v8.a;
							return $elm$core$Result$Err(e);
						} else {
...
var $author$project$Main$parseSkeleton = F2(
	function (arity, body) {
		var _v0 = A2(
			$author$project$Main$parseSkeletonTree,
			arity,
			$author$project$Main$words(body));
		if (_v0.$ === 'Err') {
			var e = _v0.a;
			return $elm$core$Result$Err(e);
		} else {
			if (!_v0.a.b.b) {
				var _v1 = _v0.a;
				var skeleton = _v1.a;
				return $elm$core$Result$Ok(skeleton);
			} else {
				return $elm$core$Result$Err(
					$author$project$Main$Error(
						_List_fromArray(
...
var $author$project$Main$parseOperator = function (operator) {
	return _Utils_update(
		operator,
		{
			result: A2(
				$elm$core$Maybe$withDefault,
				A2($author$project$Main$parseSkeleton, operator.arity, operator.body),
				A2(
					$elm$core$Maybe$map,
					$elm$core$Result$Err,
...
var $author$project$Main$instantiate = F2(
	function (_arguments, skeleton) {
		return A3(
			...
			A2(
				$elm$core$List$map,
				$author$project$Main$instantiateElement(_arguments),
				skeleton));
	});
var $author$project$Main$instantiateElement = F2(
	function (_arguments, element) {
		if (element.$ === 'Tree') {
			var l = element.a;
			return _List_fromArray(
				[
					$author$project$Main$Tree(
					A2($author$project$Main$instantiate, _arguments, l))
				]);
		} else {
			var n = element.a;
			var _v1 = A2($elm$core$Array$get, n - 1, _arguments);
			if (_v1.$ === 'Just') {
				var expr = _v1.a;
				return expr;
			} else {
...
var $author$project$Main$makeTree = F2(
	function (x, rest) {
		if (rest.$ === 'Nothing') {
			return $elm$core$Maybe$Nothing;
		} else {
...
var $author$project$Main$topQuotes = F2(
	function (arity, stack) {
		if (_Utils_cmp(
			...
			var tos = A2($elm$core$List$take, arity, stack);
			var _v0 = A3(
				$elm$core$List$foldr,
				$author$project$Main$makeTree,
	...
	function (dictionary, limit, expr, stack) {
		...
		while (true) {
			if (limit <= 0) {
				...
				if (!expr.b) {
					return $elm$core$List$reverse(stack);
				} else {
					if (expr.a.$ === 'Node') {
						var op = expr.a.a;
						var rest = expr.b;
	...
	function (msg, model) {
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							operators: A2(
								$elm$core$List$map,
								function (x) {
									return _Utils_eq(x, operator) ? $author$project$Main$parseOperator(
										transform(x)) : x;
								},
								model.operators)
						}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							operators: A2(
								$elm$core$List$cons,
								$author$project$Main$newOperator(time),
								model.operators)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DelOp':
			...
			case 'Timed':
				...
				return _Utils_Tuple2(
					model,
					A2($elm$core$Task$perform, makeMsg, $elm$time$Time$now));
			case 'UpdateExpr':
				var s = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
								...
								result: $elm$core$Result$Ok(
									A4(
										...
										A2(
											...
											_List_Nil,
											$author$project$Main$parseExpression(model.expression)),
										_List_Nil)),
								step: A2($elm$core$Basics$max, 0, model.step + n)
							}),
...
var $author$project$Main$consSap = _List_fromArray(
	[
		{
		arity: 2,
		body: '[ [ 2 ] 1 ]',
...
var $author$project$Main$coupSap = _List_fromArray(
	[
		{
		arity: 3,
		body: '[ [ 3 ] 2 ] [ 1 ] [ 1 ]',
...
var $author$project$Main$errorHtml = function (_v0) {
	var message = _v0.a;
	return A2(
		...
		A2(
			...
			A2($elm$core$List$map, $elm$html$Html$text, message)));
};
var $author$project$Main$treeToString = F2(
					...
					function (x) {
						if (x.$ === 'Node') {
							...
							return _List_fromArray(
								[
									'[',
									A2($author$project$Main$treeToString, toString, l),
									']'
								]);
						}
					},
...
var $author$project$Main$DelOp = function (a) {
	return {$: 'DelOp', a: a};
};
var $author$project$Main$UpdateOp = F2(
	function (a, b) {
		return {$: 'UpdateOp', a: a, b: b};
	});
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Main$arrow = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$attribute, 'uk-icon', 'icon: arrow-right; ratio: 2.5'),
	...
	return A2(
		...
		A2(
			...
			$elm$core$List$reverse(
				A2($elm$core$List$range, 1, arity))));
};
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $author$project$Main$setArity = F2(
	function (_new, obj) {
		return _Utils_update(
			obj,
			{arity: _new});
	});
var $author$project$Main$setBody = F2(
	function (_new, obj) {
		return _Utils_update(
			obj,
			{body: _new});
	});
var $author$project$Main$setName = F2(
	function (_new, obj) {
		return _Utils_update(
			obj,
			{name: _new});
...
var $author$project$Main$operatorRow = function (operator) {
	return _Utils_ap(
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('uk-button uk-button-default uk-button-small'),
										$elm$html$Html$Events$onClick(
										A2(
											$author$project$Main$UpdateOp,
											operator,
											$author$project$Main$setArity(
												A2($elm$core$Basics$max, 0, operator.arity - 1))))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$attribute, 'uk-icon', 'icon: minus; ratio: .5'),
								...
								_List_fromArray(
									[
										...
										A2(
											$author$project$Main$UpdateOp,
											operator,
											$author$project$Main$setArity(operator.arity + 1)))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$attribute, 'uk-icon', 'icon: plus; ratio: .5'),
												$elm$html$Html$Attributes$class('uk-preserve-width')
											]),
										_List_Nil)
									]))
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('uk-flex uk-margin-auto-vertical')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('uk-text-emphasis uk-background-default'),
												A2($elm$html$Html$Attributes$style, 'font-size', '1.1rem')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												$author$project$Main$operatorArguments(operator.arity))
											]))
									]))
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$value(operator.name),
										$elm$html$Html$Events$onInput(
										A2(
											$elm$core$Basics$composeR,
											$author$project$Main$setName,
											$author$project$Main$UpdateOp(operator))),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Example: [ [ 2 ] 1 ] [ 1 [ 2 ] ]'),
										$elm$html$Html$Attributes$value(operator.body),
										$elm$html$Html$Events$onInput(
										A2(
											$elm$core$Basics$composeR,
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('uk-preserve-width'),
										$elm$html$Html$Events$onClick(
										$author$project$Main$DelOp(operator))
									]),
								_List_Nil)
							]))
					]))
...
var $author$project$Main$stepButton = F2(
	function (value, txt) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('uk-column uk-margin-remove')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('uk-button uk-button-default uk-width-expand'),
							$elm$html$Html$Events$onClick(
							$author$project$Main$Step(value))
						]),
					_List_fromArray(
						[
...
var $author$project$Main$stepButtons = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('uk-grid uk-grid-collapse uk-margin-remove ' + 'uk-child-width-expand@s')
		]),
	_List_fromArray(
		[
			A2($author$project$Main$stepButton, -1000, '-1000'),
			A2($author$project$Main$stepButton, -100, '-100'),
			A2($author$project$Main$stepButton, -10, '-10'),
			A2($author$project$Main$stepButton, -1, '-1'),
			A2($author$project$Main$stepButton, 1, '+1'),
			A2($author$project$Main$stepButton, 10, '+10'),
			A2($author$project$Main$stepButton, 100, '+100'),
			A2($author$project$Main$stepButton, 1000, '+1000')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('uk-grid-small uk-child-width-1-6@m uk-child-width-1-3@s\n                   uk-child-width-1-1 uk-grid'),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Operator definitions')
											])),
										A2(
										$elm$html$Html$thead,
										_List_Nil,
				...
				A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('uk-textarea'),
								$elm$html$Html$Attributes$placeholder('Expression...'),
								A2($elm$html$Html$Attributes$style, 'font-family', 'monospace'),
								$elm$html$Html$Events$onInput($author$project$Main$UpdateExpr)
							]),
						_List_Nil),
					A2(
						$elm$core$List$cons,
								...
								return _List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$style, 'font-family', 'monospace'),
												$elm$html$Html$Attributes$class('uk-text-emphasis')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Step ' + ($elm$core$String$fromInt(model.step) + (': ' + $author$project$Main$expressionToString(expr))))
											]))
									]);
							}
						}())))
